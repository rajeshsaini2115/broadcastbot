...
START_STRING_PRIVATE = """ Hi {}, We are warmly welcome to the [Thank You Members Sticker Bot](https://t.me/members_stickerbot). 
...
ABOUT = """
🤖**MY NAME:** [Thank You Sticker Bot](https://t.me/members_stickerbot)
🎰**VERSION:** [3.0.1](https://t.me/mrkpmovies) 
👩‍💻**DEVELOPER:** [RAJESH SAINI](https://t.me/rajeshsaini2115)
⌨️**LAST UPDATED:** [[4-August-21]06:04 AM](https://t.me/mrkprequest)
🖥️**SERVER :** [VPS](https://digitalocean.com)
...
async def how(bot, message):
 ...
 str1 = await bot.send_sticker(chat_id,"CAADBQADZAQAAqKz4VTD-fvKH1S5bgI")  
 await txt.edit("This Sticker is Send When The Group count Hit 10 Members 👇")    
 time.sleep(5)
 await str1.delete()
 str2 = await bot.send_sticker(chat_id,"CAADBQAD2wMAAryS6FShsGzHqLCQeQI")   
 await txt.edit("This Sticker is Send When The Group count Hit 100 Members 👇")    
 time.sleep(5)
 await str2.delete()
 str3 = await bot.send_sticker(chat_id,"CAACAgEAAxkBAAIEwGDcEUGNjB5TmELSqjjMb_wciIx-AAKWAQACW9YqGG_7RELWmJBFHgQ")
 await txt.edit("This Sticker is Send When The Group count Hit 1000 Members 👇")    
 time.sleep(5)
 await str3.delete()
 str4 = await bot.send_sticker(chat_id,"CAADBQADZAQAAqKz4VTD-fvKH1S5bgI")  
 await txt.edit("This Sticker is Send When The Group count Hit 10000 Members 👇")    
 time.sleep(5)
 await str4.delete()
 str5 = await bot.send_sticker(chat_id,"CAADBQADZAQAAqKz4VTD-fvKH1S5bgI")  
 await txt.edit("This Sticker is Send When The Group count Hit 100000 Members 👇")    
 time.sleep(5)
 await str5.delete()
 str6 = await bot.send_sticker(chat_id,"CAACAgEAAxkBAAIFZmDd4aVplUsNVhTHmgRMQ6W9_WJ6AAKUAgACb8FkFIxl1Y3Zh7DUHgQ")
 await txt.edit("This Sticker is Send When The Group count Hit 1000000 Members 👇")    
 time.sleep(5)
 await str6.delete()
...
async def sticker_group(bot, message):
   try:
      ...
      if count == 3:
                    await bot.send_sticker(chat_id,"CAADBQAD7gIAAk3j4FTuFoL1qpynvAI")
      elif count == 5:
                    await bot.send_sticker(chat_id,"CAADBQADhgIAAkjO4FTnYqeyt_5_dgI")
      elif count == 7:
                    await bot.send_sticker(chat_id,"CAADBQADhAMAAkWl4FS3C7bUJ5XWGAI")
      elif count == 10:
                    await bot.send_sticker(chat_id,"CAADBQADQgQAAmvW4FSxOvM633ZVEgI")
      elif count == 20:
                    await bot.send_sticker(chat_id,"CAADBQADZAQAAqKz4VTD-fvKH1S5bgI")      
      elif count == 25:
                    await bot.send_sticker(chat_id,"CAADBQADEgMAAp_f4VQx7K5PTNDrigI")
      elif count == 30:
                    await bot.send_sticker(chat_id,"CAADBQADUQUAAulU4FQOdvZPZzVYQgI")
      elif count == 35:
                    await bot.send_sticker(chat_id,"CAADBQAD9QMAAjWu4FSK5dyh7Oi3CQI")
      elif count == 40:
                    await bot.send_sticker(chat_id,"CAADBQADuQMAAnFa4VTdUqmogdZUWwI")
      elif count == 45:
                    await bot.send_sticker(chat_id,"CAADBQADaAQAAuni4FRoGFGri5V4eAI")
      elif count == 50:
                    await bot.send_sticker(chat_id,"CAADBQADLgQAAunQ4FT0BiEhfwbF9QI")
      elif count == 55:
                    await bot.send_sticker(chat_id,"CAADBQAD-wIAAsZc6FTAbKci1E4IIAI")
      elif count == 60:
                    await bot.send_sticker(chat_id,"CAADBQADhQMAArCd4VR8iLW6FsVPmwI")
      elif count == 65:
                    await bot.send_sticker(chat_id,"CAADBQADwgIAAvkQ6VQqq8-LNz8_HgI")
      elif count == 70:
                    await bot.send_sticker(chat_id,"CAADBQADMAQAAhCM6VSoaI7m08vwugI")
      elif count == 75:
                    await bot.send_sticker(chat_id,"CAADBQADUQMAAnRg4FSt4PkjyPMAAQkC")
      elif count == 80:
                    await bot.send_sticker(chat_id,"CAADBQAD5wMAAvE_4VSppqavsyubzQI")
      elif count == 85:
                    await bot.send_sticker(chat_id,"CAADBQADgQIAAp1K4VT_eBGfnIm71QI")
      elif count == 90:
                    await bot.send_sticker(chat_id,"CAADBQADBAQAAq5o4VTYuxYWs7bIjgI")
      elif count == 95:
                    await bot.send_sticker(chat_id,"CAADBQADrAIAApfp4VRd9NM479BvNwI")
      elif count == 99:
                    await bot.send_sticker(chat_id,"CAADBQAD2wMAAryS6FShsGzHqLCQeQI")
      elif count == 100:
                    await bot.send_sticker(chat_id,"CAADBQAD_hcAArUs4FTsWP6BHlaoUgI")
      elif count == 110:
                    await bot.send_sticker(chat_id,"CAADBQAD9QEAAqOj6FTs6PPThjm8xwI")
      elif count == 120:
                    await bot.send_sticker(chat_id,"CAADBQADCgQAAtFO6FRKBZ2jAAG4JhoC")
      elif count == 125:
                    await bot.send_sticker(chat_id,"CAADBQADRwQAApIw4FT1iyxnf6BAzwI")
      elif count == 130:
                    await bot.send_sticker(chat_id,"CAADBQADPQMAAgOK4VQkdiL_8xyN-AI")
      elif count == 140:
                    await bot.send_sticker(chat_id,"CAADBQADCAQAAqL24VQHoBqDBFws7QI")
      elif count == 150:
                    await bot.send_sticker(chat_id,"CAADBQADfwQAApHk4VTKgaU_aLylPAI")
      elif count == 160:
                    await bot.send_sticker(chat_id,"CAADBQADhAIAAuq86FT42zB2KyYjxgI")
      elif count == 170:
                    await bot.send_sticker(chat_id,"CAADBQADTAIAAkIe4FQt6lrGX-I2uQI")
      elif count == 175:
                    await bot.send_sticker(chat_id,"CAADBQAD3gMAApgP4FQB4xq_y3C5qgI")
      elif count == 180:
                    await bot.send_sticker(chat_id,"CAADBQADqAIAAtfO4VR-qM-Rqs2SbgI")
      elif count == 190:
                    await bot.send_sticker(chat_id,"CAADBQADDAMAAjdF4VTEMYKtCtrAeAI")
      elif count == 199:
                    await bot.send_sticker(chat_id,"CAADBQADlgIAArLq4FQ1NEjbG27yKwI")
      elif count == 200:
                    await bot.send_sticker(chat_id,"CAADBQADygQAApln4FRb4ieiPE0RzgI")
      elif count == 210:
                    await bot.send_sticker(chat_id,"CAADBQADEQMAAuQH4FTWZ3iOUmBRFAI")
      elif count == 220:
                    await bot.send_sticker(chat_id,"CAADBQAD3wQAAkb14VSk8sqzgWwgXAI")
      elif count == 225:
                    await bot.send_sticker(chat_id,"CAADBQADYQMAAh8a4FTM_iQsHAh-AAEC")
      elif count == 230:
                    await bot.send_sticker(chat_id,"CAADBQADbwIAAmJF4FREyknW0JkK8gI")
      elif count == 240:
                    await bot.send_sticker(chat_id,"CAADBQADZwQAApO_4FSDkdyCXG_XEAI")
      elif count == 250:
                    await bot.send_sticker(chat_id,"CAADBQADbQMAAtZw4FQ4UuJlq3BgogI")
      elif count == 260:
                    await bot.send_sticker(chat_id,"CAADBQADTwMAAr7C4FQ_a5R8XKoCzgI")
      elif count == 270:
                    await bot.send_sticker(chat_id,"CAADBQADlQMAAtju6FTmEQkDgDh92AI")
      elif count == 275:
                    await bot.send_sticker(chat_id,"CAADBQAD1AMAAjHT4FT_AUri3302sQI")
      elif count == 280:
                    await bot.send_sticker(chat_id,"CAADBQADHwQAAhUy4VQYfha5s1aOnQI")
      elif count == 290:
                    await bot.send_sticker(chat_id,"CAADBQADTAMAAnsS6VSqxjqaBRfRogI")
      elif count == 299:
                    await bot.send_sticker(chat_id,"CAADBQADxwIAArcu4VQCkTS4Fk999wI")  
      elif count == 300:
                    await bot.send_sticker(chat_id,"CAADBQADhgMAAi1Z4FR-BN7Bo8G7QwI")
      elif count == 325:
